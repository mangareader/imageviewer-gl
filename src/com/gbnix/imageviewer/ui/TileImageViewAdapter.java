...
public class TileImageViewAdapter implements TileImageView.Model {
	...
	public TileImageViewAdapter(final Bitmap bitmap, final BitmapRegionDecoder regionDecoder) {
	...
	public synchronized void setScreenNail(final Bitmap bitmap, final int width, final int height) {
		Utils.checkNotNull(bitmap);
		updateScreenNail(new BitmapScreenNail(bitmap), true);
		mImageWidth = width;
		mImageHeight = height;
	...
	private void updateScreenNail(final ScreenNail screenNail, final boolean own) {
